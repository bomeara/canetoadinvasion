...
[Information about cane toads in Australia](https://www.environment.nsw.gov.au/topics/animals-and-plants/pest-animals-and-weeds/pest-animals/cane-toads)
...
```{r, cache = TRUE, echo=FALSE, include=FALSE}
  locations <- GetCaneToadLocations(country="au")
...
```{r, cache = TRUE, echo=FALSE, message=FALSE, warning=FALSE}
write.csv(extents, file="./AustraliaExtents.csv")
```

You can download the estimates of the spread of the species over time as [AustraliaExtents.csv](AustraliaExtents.csv).
